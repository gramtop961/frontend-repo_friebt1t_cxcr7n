    ...
    <section id="contact" className="py-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 flex items-center gap-4">
          <a href="https://github.com/" className="inline-flex items-center gap-2 text-slate-700 hover:text-slate-900"><Github className="h-4 w-4" /> GitHub</a>
          <a href="https://linkedin.com/" className="inline-flex items-center gap-2 text-slate-700 hover:text-slate-900"><Linkedin className="h-4 w-4" /> LinkedIn</a>
          <a href="mailto:your@email" className="inline-flex items-center gap-2 text-slate-700 hover:text-slate-900"><Mail className="h-4 w-4" /> Email</a>
        </div>
      </div>
    </section>
  )
